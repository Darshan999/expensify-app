...
const getVisibleExpenses = (expenses, { text, sortBy, startDate, endDate }) => {
    return expenses.filter((expense) => {
        ...
        // const textMatch = text === '' || text.toLowerCase() === expense.description.toLowerCase();
...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 4500, createdAt: 1000 }));
...
const demoState = {
    expenses: [{
        ...
        note: 'This was the fianl payment for that address',
        amount: 4500,
        createdAt: 0
    }],
    filter: {
...
// console.log({ ...user, ...user1 }); // name: Meet and age: 22